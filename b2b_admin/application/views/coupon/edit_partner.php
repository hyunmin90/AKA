    <div class="container admin-container">
        ...
        <div class="form-group ">
          ...
          <div class="col-xs-6">
            <input class="form-control" type="text" name="name" id="name" value="<?=$partner->name?>">
          </div>
        </div>
      </div>
      ...
      <div class="col-xs-12">
        <div class="form-group ">
          ...
          <div class="col-xs-3">
            ...
            <input type="text" class="form-control" name="admin_id" id="admin_id"  value="<?=$partner->admin_id?>">
        ...
        <div class="form-group ">
          ...
          <div class="col-xs-10">
            <?php foreach ($categories as $value) {
                  ...
                  if ($partner->{$cate} == 'Y') $checked = "checked";
                  else $checked = "";
      ...
      <div class="col-xs-12">
        <div class="form-group ">
          ...
          <div class="col-xs-5">
                ...
                <div class="col-xs-8">
                  <input class="form-control" type="date" name="start" id="start" value="<?=$partner->start_date?>">
                </div>
          ...
          <div class="col-xs-5">
                ...
                <div class="col-xs-8">
                  <input class="form-control" type="date" name="close" id="close"  value="<?=$partner->close_date?>">
                </div>
        ...
        <div class="form-group ">
          ...
          <div class="col-xs-6">
            <?php foreach ($products as $value) {
              ...
              $id = $value->id;
              $kind = $value->kind;
              if ($partner->product_id == $id) $checked = "checked";
              else $checked = "";
            ?>
            <label class="checkbox-inline">
      ...
      <div class="col-xs-12">
        <div class="form-group ">
          ...
          <div class="col-xs-6">
            <input class="form-control" type="text" name="word_limit" id="word_limit"  value="<?=$partner->word_limit?>">
          </div>
        </div>
      </div>
      ...
      <div class="col-xs-12">
        <div class="form-group ">
          ...
          <div class="col-xs-6">
            <input class="form-control" type="text" name="send_limit" id="send_limit" value="<?=$partner->send_limit?>">
          </div>
        </div>
      </div>
      ...
      <div class="col-xs-12">
        <div class="form-group ">
          ...
          <div class="col-xs-10">
            <label class="checkbox-inline">
              <input type="checkbox" id="active_page" name="active_page[]" value="1" <?php if ($partner->active_coupon == "Y")  {?>checked<?php } ?>>Coupon
            </label>
            <label class="checkbox-inline">
              <input type="checkbox" id="active_page" name="active_page[]" value="2" <?php if ($partner->active_user == "Y")  {?>checked<?php } ?>>User
            </label>
          </div>
        </div>
      </div>
...
//alert(activated);
    ...
    {
        save = confirm('Do you update this partner?');

        if(save)
        {
          $('form#fm').attr({action:'/admin/b2b/update_partner'}).submit(); 
        }            
    }    
  }) // Create coupon end.
  ...
  $('#cancel').click(function(){
    //alert("bbbbbbb");
    window.location.href = '/admin/b2b/partner/'+id;
